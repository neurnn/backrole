...
namespace Backrole.Crypto
{
    ...
    /// Signature Value.
    /// </summary>
    public struct SignValue : IEquatable<SignValue>, IAlgorithmParameter
    {
        private static readonly string EMPTY_NAME = "";
        private static readonly byte[] EMPTY_BYTES = new byte[0];

        /// <summary>
        /// Empty Value of the <see cref="SignValue"/>.
        /// </summary>
        public static readonly SignValue Empty = new SignValue();

        /// <summary>
        /// Initialize a new <see cref="SignValue"/>.
        /// </summary>
        /// <param name="Name"></param>
        /// <param name="Value"></param>
        public SignValue(string Name, byte[] Value)
        {
            this.Name = Name;
            this.Value = Value;
        }
        ...
        public static bool operator ==(SignValue Left, SignValue Right) => Left.Equals(Right);
        public static bool operator !=(SignValue Left, SignValue Right) => !Left.Equals(Right);
        ...
        /// </summary>
        /// <returns></returns>
        public static bool TryParse(string Input, out SignValue Output)
        {
            ...
            if (Collon > 0)
            {
                ...
                if ((Hex.Length % 2) == 0 && Hex.IsHexString())
                {
                    ...
                    Output = new SignValue(Name, Value);
                    return true;
                }
            }
        ...
        /// <param name="Input"></param>
        /// <returns></returns>
        public static SignValue Parse(string Input)
        {
