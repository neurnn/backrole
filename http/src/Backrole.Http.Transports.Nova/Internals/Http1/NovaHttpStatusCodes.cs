...
{
    internal class NovaHttpStatusCodes : Dictionary<int, string>
    {
        private NovaHttpStatusCodes()
        {
        ...
        /// Status Code Table.
        /// </summary>
        public static NovaHttpStatusCodes Table { get; } = new NovaHttpStatusCodes();
    }
}
